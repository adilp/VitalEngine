...
/**
 * Created by Adil on 10/14/16.
 */
public class RecyclerFromMessage  extends AppCompatActivity implements SearchView.OnQueryTextListener {

    List<DoctorObject> messageDataList;

    private RecyclerView mRecyclerView;
    private CustomRecyclerFromMessage adapter;
...
//    }
    ...
    private Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case 1:
                    adapter = new CustomRecyclerFromMessage(RecyclerFromMessage.this, (ArrayList<DoctorObject>) messageDataList);
                    mRecyclerView.setAdapter(adapter);
                    LinearLayoutManager layoutManager
                            = new LinearLayoutManager(RecyclerFromMessage.this, LinearLayoutManager.VERTICAL, false);
