    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try {
                ...
                String url = "https://staging.vitalengine.com/uaa/oauth/token";
                ...
                LoginActivity.this.startActivity(myIntent);
                            ...
                            Log.e("VolleyAuthFail", e.toString());
                            result =2;
...
//            }
    ...
    private void callApi(final String mEmail) {
        ...
        String url = "https://staging.vitalengine.com/portal-api/api/login/getUserDetails?userName=" + mEmail;
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(Call call, okhttp3.Response response)  {
                ...
                try {
                    ...
                    Log.e("USERAPI", String.valueOf(sub));
                    String usertype = sub.getString("userType");
                    String userName = sub.getString("userName");
                    String userId = sub.getString("userId");
                    String firstName = mEmail;
