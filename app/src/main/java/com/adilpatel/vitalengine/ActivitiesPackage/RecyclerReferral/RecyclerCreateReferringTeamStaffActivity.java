...
public class RecyclerCreateReferringTeamStaffActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent myIntent = new Intent(context, RecyclerReferralConfirmActivity.class);
    ...
    private Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case 1:
                    adapter = new CustomRecyclerAdapterCreateReferringTeamStaff(RecyclerCreateReferringTeamStaffActivity.this, (ArrayList<StaffObject>) messageDataList);
                    mRecycerView.setAdapter(adapter);
                    LinearLayoutManager layoutManager
                            = new LinearLayoutManager(RecyclerCreateReferringTeamStaffActivity.this, LinearLayoutManager.VERTICAL, false);
